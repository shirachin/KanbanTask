      ...
      <section class="help-section">
        ...
        <div class="section-description">
          ...
          <ul class="feature-list">
            ...
            <li><strong>タスクの削除</strong>: タスク編集モーダルの左下にある「削除」ボタンをクリックすると、確認ダイアログが表示されます。確認するとタスクが削除されます。この操作は取り消せません。</li>
            <li><strong>ステータスの変更</strong>: タスク編集モーダルでステータスを選択して変更できます。すべてのプロジェクト・個人タスクで共通の7種類のステータス（検討中、未実行、実行中、レビュー待ち、検証環境反映済み、本番環境反映済み、中止）を使用します。</li>
